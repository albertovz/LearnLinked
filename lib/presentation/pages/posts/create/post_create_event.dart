...
import 'package:learn_linked/src/presentation/pages/posts/create/posts_create_state.dart';
...
class PostsCreateEvent extends ChangeNotifier {
  ...
  createPost() async {
    ...
    if (_state.isValid()) {
      ...
      print('descripción: ${_state.description.value}');
      print('categoría: ${_state.category}');
      print('idUser: ${_state.idUser}');
      print('latitud: ${_state.latitud}');
      print('longitud: ${_state.longitud}');
      print('name error: ${_state.name.error}');
      print('contentType: ${_state.contentType}');
    }
  }
