...
// import 'package:learn_linked/src/presentation/pages/resource/create/posts_create_state.dart';
...
// class PostsResourceCreateEvent extends ChangeNotifier {
//   PostsResourceCreateState _state = PostsResourceCreateState();
//   PostsResourceCreateState get state => _state;
...
//   PostsResourceCreateEvent(this._authUseCases, this._postsResourceUseCases) {
//     // _state =
...
//   Future<List<ResourceModel>> getLocalPosts() async {
//     SharedPreferences prefs = await SharedPreferences.getInstance();
...
//       ResourceModel localPost = ResourceModel(
//           category: category,
//           name: name,
...
//     try {
//       List<ResourceModel> localPosts = await getLocalPosts();
//       SharedPreferences prefs = await SharedPreferences.getInstance();
//       String? imagePath = prefs.getString(imagePathKey);
//       File imageFile = File(imagePath!);

//       for (ResourceModel localPost in localPosts) {
//         // Realiza el post al servidor utilizando el método create del use case
//         Resource response =
//             await _postsResourceUseCases.create.launch(localPost, imageFile);
...
//         _response =
//             await _postsResourceUseCases.create.launch(_state.toPost(), _state.image!);
//       } else {
