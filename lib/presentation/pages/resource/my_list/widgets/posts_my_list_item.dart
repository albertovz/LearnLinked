...
class PostsResourceMyListItem extends StatelessWidget {
  Post post;
  PostsResourceMyListEvent vm;

  PostsResourceMyListItem(this.vm, this.post);
              ...
              children: [
                ...
                Column(
                  children: [
                    IconButton(
                        onPressed: () {
                          Navigator.pushNamed(context, 'group/update',
                              arguments: post);
                        },
                        icon: const Icon(
                          Icons.edit,
